...
const { normalize, denormalize, getId, isRelationship, normalizePath } =
  initService({
...
application.utils.isRelationship = isRelationship;
application.utils.normalizePath = normalizePath;
